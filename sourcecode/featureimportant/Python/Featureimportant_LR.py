...
def tunparameter(x_train,y_train):
    param_range_penalty = ['l2']
    param_range_C = [0.001, 0.01, 0.1, 1]
    param_grid = [{'clf__penalty': param_range_penalty, 'clf__C': param_range_C}]
    pipe_rf = Pipeline([('clf', LogisticRegression())])
    best_score = 0
...
def fun(file):
    ...
    ss='C:/gln/myclassoverlap/imbalanceoverlap/result/feature/LR/original/original_'+file
    feature_original.to_csv(ss,index=False)
    ss1='C:/gln/myclassoverlap/imbalanceoverlap/result/feature/LR/remove/remove_'+file
    feature_remove.to_csv(ss1,index=False)
    ss2 = 'C:/gln/myclassoverlap/imbalanceoverlap/result/feature/LR/SMOTE/SMOTE_' + file
    feature_SMOTE.to_csv(ss2, index=False)
    ss3 = 'C:/gln/myclassoverlap/imbalanceoverlap/result/feature/LR/ovim/ovim_' + file
    feature_ovim.to_csv(ss3, index=False)
    ss4 = 'C:/gln/myclassoverlap/imbalanceoverlap/result/feature/LR/imov/imov_' + file
    feature_imov.to_csv(ss4, index=False)
    ss5 = 'C:/gln/myclassoverlap/imbalanceoverlap/result/feature/LR/NCL/NCL_' + file
    feature_NCL.to_csv(ss5, index=False)
    ss6 = 'C:/gln/myclassoverlap/imbalanceoverlap/result/feature/LR/IKMCCA/IKMCCA_' + file
