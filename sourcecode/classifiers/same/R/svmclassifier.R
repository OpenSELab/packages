...
for (k in 1:length(days)){
  ...
  df <- rbind(df,va)
  s_result<-paste("E:/gln/C/mypackage/result_new/RQ2/R/tune/DE/SVM/SDP/",days[k],".csv",sep='')
  ...
  colnames(df_para)<-c("C")
  s_para=paste("E:/gln/C/mypackage/result_new/RQ2/R/tune/DE/param/SVM/SDP/",days[k],".csv",sep='')
